...
class IntegrationException(Exception):
    ...
    This may be because communication failed (RemoteIntegrationException), or because local configuration is
...
class RemoteIntegrationException(IntegrationException):
    ...
    def __init__(self, url_or_service, message, debug_message=None):
        ...
        :param url_or_service: Name of the service that failed (ex: "Overdrive"), or the specific URL that
            had the problem.
        """
...
class BadResponseException(RemoteIntegrationException):
    ...
    def __init__(self, url_or_service, message, debug_message=None, status_code=None):
        ...
        self.status_code = status_code      # to be set to 500, etc.
    ...
    def from_response(cls, url, message, response):
        ...
        return BadResponseException(url, message, status_code=status_code,
                                    debug_message=f"Status code: {status_code}\nContent: {content}")
...
class HTTP:
    ...
    def _request_with_timeout(cls, url, make_request_with, *args, **kwargs):
        ...
        # TODO: Can this be removed or simplified under Py3?
        ...
        try:
            ...
            if len(args) == 1:
                # requests.request takes two positional arguments, an HTTP method and a URL. In most cases, the URL
                # gets added on here. But if you do pass in both arguments, it will still work.
                args = args + (url,)
