...
@pytest.mark.parametrize(
    'expected_address, remote_address, headers', [
        ...
        ('128.128.1.10', '192.168.1.10', {'X-Forwarded-For': '128.128.1.10,192.168.1.20'}),
        ('128.128.1.10', '192.168.1.10', {'x-forwarded-for': '192.168.2.20, 128.128.1.10'}),
        ('128.128.1.10', '192.168.1.10', {'x-forwarded-for': '192.168.2.20, 192.168.1.20, 128.128.1.10'}),
    ])
