...
class TestAdminUI(object):
    ...
    @pytest.mark.parametrize(
        ...
        [
            [
                ...
                "/static/library-registry-admin.css",
            ],
            [
                "admin_css",
                OperationalMode.production,
            ...
            [
                "admin_js",
                OperationalMode.development,
                "/static/library-registry-admin.js",
            ],
            [
                "admin_js",
                OperationalMode.production,
    ...
    def test_lookup_asset_url(
        self, asset_key: str, operational_mode: OperationalMode, expected_result: str
    ):
