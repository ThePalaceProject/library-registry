...
class TestRegistrar:
    ...
    def test_opds_response_links(self):
        ...
        actual = LibraryRegistrar.opds_response_links_to_auth_document(response, "http://opds-server/auth-document")
    ...
    def test__required_email_address(self):
        ...
        # Changing the title doesn't affect the original ProblemDetail document.
