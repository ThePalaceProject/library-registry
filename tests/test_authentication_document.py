...
class TestParseCoverage(DatabaseTest):
    # TODO: Convert this to a more pytest-style parameterized test set
    ...
    def parse_places(self, coverage_object, expected_places=None,
        ...
        """
        place_objs, unknown, ambiguous = AuthDoc.parse_coverage(self._db, coverage_object, MockPlace)
    ...
    def test_ambiguous_place_within_country(self):
        ...
        MockPlace.by_name["US"] = us
        self.parse_places({"US": ["Springfield"]}, expected_ambiguous={"US": ["Springfield"]})
    ...
    def test_unknown_place_within_country(self):
        ...
        self.parse_places({"US": "Nowheresville"}, expected_unknown={"US": ["Nowheresville"]})
...
class TestLinkExtractor:
    ...
    def online_registration_for_one_authentication_mechanism(self):
        # TODO: This test is clearly breaking isolation. Investigate.
        """
...
class TestUpdateServiceAreas(DatabaseTest):
    ...
    def test_ambiguous_and_unknown_places_become_problemdetail(self):
        ...
        library = self._library()        
        valid = [self._place()]                 # We were able to identify one valid place.
...
class TestUpdateCollectionSize(DatabaseTest):
    ...
    def test_success(self):
        ...
        actual = sorted([(x.language, x.size) for x in self.library.collections])
